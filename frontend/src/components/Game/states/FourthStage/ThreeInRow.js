...
export default class ThreeInRowState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Голос', 'До Вашого столу впевнено прямував начальник. Ви весь підібралися і насторожились, вимушено посміхнулися', () => this.next());
        yield;

        this.game.displayDialogLine('Начальник', 'Добрий день. Я хочу поговорити з Вами про кар\'єрний ріст, який, як Ви знаєте, будується в ІТ на проходженні позицій від Junior до Middle і Senior', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Начальник', 'Поряд з переходом в керівники проектів є можливість і переходу в архітектори. Складно сказати часом, до якого ж типу зростання стосується ця роль, оскільки за рівнем компетенцій вона, безумовно, не менше відповідальна', () => this.next());
        yield;

        this.game.displayDialogLine('Начальник', 'Але при цьому тут швидше йдеться про розвиток в частині експертизи, напрацювання знань в технологіях, більш глибокому зануренні в саму технологічну і стратегічну частину проекту', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Ви', 'Ви, сповнені амбіційних надій, занурились у роботу над проектом, що Вам доручили', () => this.next());
        yield;
