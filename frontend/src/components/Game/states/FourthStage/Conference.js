...
export default class WWHState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Голос', 'Як же приємно дивитись на величну сучасну споруду, усвідомлюючи, що Ви працюєте в одному з її комфортабельних офісів. Вам подобається Ваша робота, колектив, сфера діяльності, але останнім часом все частіше стали відвідувати думки про кар\'єрний ріст', () => this.next());
        yield;
        ...
        if (!this.friend){
            ...
            this.game.displayDialogLine('Голос', 'Залишилось лише погодитися із нею. Серед варіантів професійного росту: конференцій, курсів підвищення кваліфікації, тренінгів та семінарів, - "Управління IT інфраструктурою, розробка стратегії IT" - досить цікавий, щоб зосередитись на ньому', () => this.next());
            yield;
        ...
        this.game.displayDialogLine('Голос', 'Коли Ви потрапили на конференцію, у Вас перехопило подих. Це був величезний майданчик з відкритим верхом і сценою. Ви ще ніколи не бачили такого скупчення програмістів, системних адміністраторів та дизайнерiв з усіх куточків світу', () => this.next());
        yield;
