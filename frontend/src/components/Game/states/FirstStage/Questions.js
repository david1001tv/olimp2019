...
export default class QuestionsState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Ви', 'Ви розумієте, яку помилку допустили, обравши останню парту. Слова Анастасії Марковни, як вона представилась, долітають до вас через одне', () => this.next());
        yield;

        this.game.displayDialogLine('Ви', 'Пересісти ближче немає можливості: всі місця зайняті. Добре хоч екран великий, і можна здогадатися, що за слово Ви не почули, ознайомившись з інформацією', () => this.next());
        yield; 
