...
export default class IntroState extends Phaser.State {
    * gen() {
        ...
        if (this.firstAnswer == 'Girl'){
            this.game.displayDialogLine('Голос', 'Ну ні, чоловік більш лякає Вас, ніж привертає. Треба бути зовсім безстрашним, щоб тільки заговорити з ним. "Не сьогодні", - вирішуєте Ви і прямуєте до дівчини', () => this.next());
            yield;
            ...
            //Выбор: "Не открываться"
                ...
                yield;
                this.game.displayDialogLine('Голос', 'Відчув себе ніяково, Ви все ж вирішили сказати, що вас турбує', () => this.next());
            }
            yield;
            ...
            this.game.displayDialogLine('Голос', 'Ви важко зітхнули і дослухалися до її слів. Соромно зізнатись, але донедавна Ви були впевнені, що у програмуванні жінкам не місце… Ох уж ці стереотипи! Крім того, Надія не виглядала ні дивною, ні асоціальною, ні занедбаною. Ваші сумніви поряд з нею здавалися надуманими та сміховинними', () => this.next());
            yield;
        ...
        //Выбор: "Подойти к мужчине"
            ...
            this.game.displayDialogLine('Голос', 'Потрібно віддати належне, цей чоловік умів переконувати. Розмова з ним надала сил позбутися колишніх сумнівів. З відчуттям спокою та впевненості, Ви увійшли до університету', () => this.next());
            yield;
        }
