...
export default class CrossState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Голос', 'Якщо Ви вибираєте "майданчик для старту", тоді варто віддати перевагу варіанту з більшими можливостями для власного розвитку. Чи може Ви перебуваєте в пошуку стабільності? Тоді варто обирати пропозицію з гарантованими незмінними умовами', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Голос', 'Це було важко, але Ви впорались! Залишилось підписати договір, та це вже дрібниці. Ви подолали ще один важкий етап життя, попереду чекає кар\'єрний ріст. Успіхів!', () => this.next());
        yield;
