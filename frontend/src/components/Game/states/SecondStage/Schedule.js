...
export default class ScheduleState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Голос', 'Поки він говорив, до вас наблизилась Анастасія Марківна, привертаючи увагу всіх юнаків, що одразу приосанились', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Анастасія Марківна', 'Моя сфера - комп\'ютерна графіка та веб-дизайн. Працюючи з сучасними графічними редакторами, ми з вами будемо створювати макети сайтів, анімаційні ролики, графічні елементи композицій та багато іншого. Сподіваюся, мої предмети змусять прокинутися в вас творчі таланти. Кращим стає лише той дизайнер, що відчуває креативне у звичайному', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Голос', 'Попереду чекає ще багато цікавих дней. Ваша професія занадто швидко розвивається, щоб ще залишився час для нудьги', () => this.next());
        yield;
