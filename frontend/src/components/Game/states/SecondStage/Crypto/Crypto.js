...
export default class CryptoState extends Phaser.State {
    * gen() {
        ...
        Вам уявляються секретні знання, недосяжні для звичайних людей. Та ось наближається Тарас \
        Денисович, і на книжці у його руках Ви читаєте “Криптографія”. Що ж, звучить цікаво!', 
        () => this.next());
        yield;
        ...
        this.game.add.tween(this.cathedra).to({
            ...
            this.game.add.tween(this.machine).to({
                ...
                this.generateStage();
                this.generateKey(1);
                this.teacherAppears('Ви', 'Доброго дня, Тарас Денисович!');
            }); 
        }); 
        yield;

        this.game.displayDialogLine('Тарас Денисович', 'Вітаю! Я здивований, що Ви прийшли \
        до мене на пару раніше її початку. Для магістрів це дуже рідке явище! Криптографія - дуже \
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Та невже!? Ну гаразд, я Вас уважно слухаю', 
        () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Хм, розробка сайта університету? Звучить доволі серйозно. Гаразд, я допоможу Вам. Але не сподівайтесь, що я сам все розкажу! Найкращий спосіб\
        засвоїти матеріал - це використати його на практиці. Отже, якщо Ви дійсно бажаєте розбиратися у\
        шифрувальних алгоритмах, доведеться виконати кілька моїх завдань', 
        () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Добре, тоді почнемо!', 
        () => this.next());
        yield;

        this.game.displayDialogLine('Тарас Денисович', 'Перше завдання для Вас буде пов\'\язано \
        ...
        Б стане Д, і так далі. Спробуйте зашифрувати слово у верхньому полі за допомогою шифра Цезаря з ключом ' +
        this.currentKey, 
        () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Чекатиму на Вас для наступного завдання. Хай щастить!', 
        () => this.next());
        yield;
        ...
        this.teacherDisappears(function() {
            ...
            context.generateWord(1, function() {
                ...
                context.teacherAppears('Тарас Денисович', 'Непогано як для початку, але це далеко не все, що у мене є.\
                Готові продовжити?');
            });
        });
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Тоді перейдемо до наступного алгоритму', 
        () => this.next());
        yield;

        this.game.displayDialogLine('Тарас Денисович', 'Шифр Віженера - метод поліалфавітного\
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Спробуйте зашифрувати наступне слово із таким ключем: '+
        ...
        this.teacherDisappears(function() {
            ...
            context.generateWord(2, function() {
                context.teacherAppears('Тарас Денисович', 'В Вас дуже непогано виходить! Однак в мене є для Вас ще дещо.\
                Не втомилися?');
            });
        });
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Тоді останній на сьогодні шифр - шифр Атбаш.\
        Це простий шифр підстановки для алфавітного письма. Правило шифрування полягає в заміні i-й літери\
        алфавіту буквою з номером n - i + 1, де n - число букв в алфавіті. Зашифруйте наступне слово за допогою шифру Атбаш', 
        () => this.next());
        yield;
        ...
        this.teacherDisappears(function() {
            ...
            context.generateWord(3, function() {
                context.teacherAppears('Тарас Денисович', 'Добре! \
                Сподіваюсь, що цей матеріал допоможе Вам зробити безпечну систему зберігання паролів.\
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Завжди радий допомогти! Коли не зайнятий...', 
        () => this.next());
        yield;

        this.teacherDisappears(function() {
            context.warning.text = context.game.add.text(625, 35, 'Відмінна робота! Ви ознайомилися з\nосновними видам алгоритмів шифрування\nта маєте можливість самостійно\nобрати для себе найкращий!', {
                fontSize: 29,
                font: 'Leftonade',
            })
            context.toggleWarning(1, function() {
