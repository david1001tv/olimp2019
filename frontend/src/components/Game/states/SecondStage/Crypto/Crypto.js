...
export default class CryptoState extends Phaser.State {
    * gen() {
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Вітаю, студент! Я здивований, що ти прийшов \
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Та невже !? Ну гаразд, я тебе уважно слухаю', 
        () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Хм, розробка сайта університету? Звучить доволі серйозно\
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Перше завдання для тебе буде пов\'\язано \
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Чекатиму на тебе для наступного завдання. Хай щастить!', 
        () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Спробуй зашифрувати наступне слово із таким ключем: '+
        ...
        this.teacherDisappears(function() {
            ...
            context.generateWord(2, function() {
                context.teacherAppears('Тарас Денисович', 'В тебе дуже непогано виходить! Однак в мене є для тебе ще дещо.\
                Не втомився?');
            });
        });
        yield;
        ...
        this.teacherDisappears(function() {
            ...
            context.generateWord(3, function() {
                context.teacherAppears('Тарас Денисович', 'Молодець, я в тобі і не сумнівався.\
        ...
        this.game.displayDialogLine('Тарас Денисович', 'Завжди радий допомогти!', 
        () => this.next());
        yield;
