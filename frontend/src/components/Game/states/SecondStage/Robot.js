...
export default class Scanner extends Phaser.State {
    async * gen() {
        ...
        this.game.displayDialogLine('Голос', 'До отримання диплома магістра залишилося скласти останній предмет, який насправді найскладніший з усіх. Суттю даного предмета є вивчення та розробка штучного інтелекту, але як можна навчити думати "залізяку"?', () => this.next());
        yield;

        this.game.displayDialogLine('Голос', 'Залишається сподіватися, що Адам Вікторович  в цьому допоможе...', () => this.next());
        yield;
        ...
        this.game.displayDialogLine('Адам Вікторович', 'На жаль, у нього є пару багів, через що він іноді генерує випадкові слова, які Вам необхідно визначити і усунути. Дізнатися, чи вірно визначили зайві слова, Ви зможете по очах робота', () => this.next());
        yield;
        ...
        if (this.porc > 80){
            ...
            this.game.displayDialogLine('Ви', 'Вийшло не дуже, але принаймні це працює. Повстання машин настане точно не скоро ...', () => this.next());
        }
        yield;
        ...
        this.game.displayDialogLine('Голос', 'Ви так запрацювалися, що й забули про те, що вранці говорив Вам Адам Вікторович, завтра вже вручення диплома! Цікаво, чи зможете Ви отримати червоний?', () => this.next());
        yield;

        this.game.displayDialogLine('Адам Вікторович', 'Ну все, йди відпочивай, в мене ще є пару справ', () => this.next());
        yield;
