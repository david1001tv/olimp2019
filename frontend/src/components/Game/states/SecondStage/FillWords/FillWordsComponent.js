...
let descriptions = [
    ...
    'Це місце, де зберігаються і підтримуються будь-які дані. Найчастіше дані в репозиторії зберігаються у вигляді файлів, доступних для подальшого поширення мережою. Контекст - створив репозиторій',
    ...
    'Це підхід управління проектами для гнучкої розробки програмного забезпечення. Ви ознайомитесь із ним під час навчання',
    ...
    'Це фахівець, який займається тестуванням програмного забезпечення з метою виявлення помилок в його роботі і їх подальшого виправлення',
    ...
    'Це журнал тієї роботи, яка залишилася і яку необхідно виконати команді',
    ...
    'Збірка Репорт призначена для роботи з регламентними звітами. Програмування з використанням даної збірки полягає в послідовному створенні або відкритті та налаштування звіту'
];
